  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 border border-slate-100">
        ...
        <p className="text-slate-500 text-center mb-8">Join the CompanionX community.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input 
            type="text" placeholder="Phone (e.g., 017...)" required
            className="w-full p-3 border rounded-xl bg-slate-50 focus:ring-2 focus:ring-blue-500 outline-none"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex flex-col">
              <label className="text-xs text-slate-400 mb-1 ml-1">Date of Birth</label>
              <input 
                type="date" required
                className="p-3 border rounded-xl bg-slate-50 focus:ring-2 focus:ring-blue-500 outline-none"
          ...
          <input 
            type="text" placeholder="Guardian Contact (Emergency)" required
            className="w-full p-3 border rounded-xl bg-slate-50 focus:ring-2 focus:ring-blue-500 outline-none"
